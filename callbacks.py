...
def get_callbacks(app):
    @app.callback(
        Output("avatar", "src"),            # picture change -> src change (id, attribute)
        Input("avatar-btn", "n_clicks"),    # Button click -> click change
    )
    def update_avatar(clicks):      # attribute means the number of input
